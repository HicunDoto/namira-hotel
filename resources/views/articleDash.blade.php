...
<div class="dashboard">
    <div class="menu-dashboard">
        <div class="anak-dashboard">
            ...
            <a href="articleDash" class="d-flex">
                <div class="articleDash a-href a-h2 a-href-aktif">
    ...
    <div class="article align-items-center  flex-column d-flex" id="article" >
        <h1>Artikel</h1>
        <a href="createArticle" class="btn create-artikel">Buat artikel +</a>
        <table id="tableArtikel" class="display" style="width:fit-content">
            <thead>
                <tr>
                    <th>Name</th>
                    <th>Url</th>
